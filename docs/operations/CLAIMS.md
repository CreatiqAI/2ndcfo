...
3. The receipt upload opens automatically. Select multiple files in one batch;
   subsequent batches can be added to the same draft claim. Choose Done to return
   to the bundle. Totals update as extraction completes or receipt reviews are saved.
